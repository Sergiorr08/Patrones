...
public class CuentoTerror implements Cuento {
    ...
    public String getCuento() {
        ...
        "\n" +
        "— ¿Acaso no se ha enterado? —añadió la voz—. El señor Salcedo fue víctima de un accidente en la carretera y ella se encuentra en su funeral.\n" +
        "\n" +
        "El señor Salcedo cortó la llamada sin decir una palabra y acercó el celular a su rostro como si fuera a tomarse una foto.\n" +
        "\n" +
        "Lo que vio en la pantalla fue espeluznante, su rostro era una máscara de humo negro y de su imagen ya no quedaba nada.";
